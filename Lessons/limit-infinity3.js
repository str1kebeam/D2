var canvas_minx3 = 0;
            ...
            var graph_coords3 = [];
            var n3 = 95;
            var dx3 = 0; // set value w.r.t. n in init3()
        ...
        function init3() {
            ...
            dx3 = (scene_maxx3 - scene_minx3)/n3;
            x = scene_minx3;
            for (i=0; i<n3; i++) {
                y = graph_function3(x);
            ...
            // init3ial tangent point location
            scene_graphx = 0.5;
        ...
        function draw_stuff3() {
            ...
            for (var i = Math.floor(scene_minx3) + 1; i < Math.floor(scene_maxx3); i += 1){
                ctx3.beginPath();
                ctx3.moveTo(canvas_x3(i),canvas_y3(scene_miny3));
                ctx3.lineTo(canvas_x3(i),canvas_y3(scene_maxy3));
                ctx3.stroke();
			}
			for (var i = Math.floor(scene_miny3) + 1; i < Math.floor(scene_maxy3); i += 1){
                ctx3.beginPath();
			...
			ctx3.fillText("x",canvas_maxx-30.0,canvas_xaxis_zeroy-13);
            ctx3.fillText("y",canvas_yaxis_zerox-20.0,canvas_miny+30.0);
